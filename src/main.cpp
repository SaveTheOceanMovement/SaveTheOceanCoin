...
unsigned int nStakeMaxAge = 31 * 24 * 60 * 60;
...
const string strMessageMagic = "SaveTheOcean Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
	...
	{ 
		nSubsidy = 10000000 * COIN; return nSubsidy; 
	}
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "SaveTheOcean", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Restoring The Oceans Could Feed 1 Billion People A Healthy Seafood Meal Each Day";
        CTransaction txNew;
        txNew.nTime = 1472657052;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
		...
		uint256 nhashMerkleRoot = uint256("c436b7e5c7b772b93d5ebd423317a8db3976bf10686ba53645b36cf26fd3359b");
